...
$sql = "SELECT * FROM workers WHERE service='Cleaner'";
...
<h2 class="section-title">Our Professional Cleaners</h2>
...
<article>
<img src="uploads/<?php echo $row['image']; ?>" alt="Cleaner">
...
echo "<h3>No cleaners available</h3>";
}
?>
